...
If you followed the [Setup instructions](https://sydney-informatics-hub.github.io/training.alphafold/setup.html), then you should already have the required software installed. If not, please go do this now!
