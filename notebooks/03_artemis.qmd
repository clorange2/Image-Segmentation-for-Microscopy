...
For our demo, we will work in the *Training* project in a sub-folder of our creation. Your projects in the `/project` folder have up to 1TB of storage space available shared between other members of your [project](dashr.sydney.edu.au).
...
| JobName.**o**JobID**_usage** | short summary of the resources **used** by your job |
