...
There are several (large) required genetic databases and parameters AlphaFold requires. Different versions of these are conveniently available on Artemis in the common folder: `/project/data/alphafold2/`
