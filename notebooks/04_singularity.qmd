...
There are [many different versions of AlphaFold](https://hub.docker.com/search?q=alphafold) installations that utilise docker to ultimately run. We provide a [couple options for configuration and running AF](https://hub.docker.com/r/sydneyinformaticshub/alphafold). You may use this container on any system that supports it.
...
We first make a new jobscript for the build step, `nano run_build.pbs`:
